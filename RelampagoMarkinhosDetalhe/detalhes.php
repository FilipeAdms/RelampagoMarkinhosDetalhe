...
<head>
    ...
    <style>
        ...
        .card-body .description {
            text-align: justify; /* Justifica o texto da descri��o */
        }
    </style>
</head>
            ...
            <div class="card">
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="details">
                        ...
                        <p><b>Marca:</b> <?php echo convertedata($dados['Marca']); ?></p>
                        <p><b>Modelo:</b> <?php echo htmlspecialchars($dados['Modelo']); ?></p>
                        <p><b>Ano:</b> <?php echo htmlspecialchars($dados['Ano']); ?></p>
                        <p><b>Valor:</b> R$ <?php echo number_format($dados['Preço'], 2, ',', '.'); ?></p>
                    </div>
                </div>
